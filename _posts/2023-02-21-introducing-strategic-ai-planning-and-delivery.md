...
Because there's always a lot of talk about the future and the possibilities and what can happen, and of course research, which can get a little honestly, complicated and very hard to do that on a podcast. Although there are podcasts that do that, that focus on some of those low level details. I wonder how they do that.
...
**Kathleen Walch:** We also have an ethical and responsible AI course that we offer, because that's become quite a hot topic and people want to make sure that they're thinking about building ethical and responsible AI tools, especially as it's getting adopted more mainstream and put into practice. So that is, you know, in a nutshell what we offer at Cognilytica.

**Kathleen Walch:** In addition, we also run a number of different events. Because we wanted to not only talk about it and then educate people, but then show them how it's actually being applied in the real world. So we haveenterprise-focused events where it's enterprise and data focused, talking about how they're implementing Big Data, AI, advanced analytics, and then we have a government-focused event series as well, where we have state and local, federal, and then international governments as well talk about how they are adopting AI.
...
**Bill Raymond:** Yeah, and Ron, I'd love to hear your thoughts, but just a quick little thought on that, Kathleen. I actually, so I'm a consultant, I help other organizations do work. And this is something that has been a challenge for me for years because sometimes the organization just says, Oh, your password needs to be reset because you've hit some three month period or something like that.

And anytime I try to do it, all of a sudden they're telling me to go to this website in their corporate network that I can't access because my password's not working. And I just wanted to share an example of this. One of my clients set up a phone system where you can have a natural language conversation with it, and then it helps you do the password reset outside of the network.

**Bill Raymond:** It's still all very secure and all that good stuff, but it just walks you through it. And I thought, wow, that's such a great use of it. And all I did was say, I'm an external contractor, I need to reset my password. It understood that and it brought me through the process that I maybe wouldn't be able to see on their internal corporate site.
...
**Ron Schmelzer:** These are the measures of success for an organization. And when we're applying AI, a lot of it comes down to improving things that can be increasingly better automated, even though automation is not the same thing as intelligence, because you can program something to do something repeatedly and that's automation.

But we can make the automation more intelligent so they're kind of cutting across each other, right? We can add one to the other. And when we do that, we can do things like have systems that automatically look in our email inboxes and extract things like invoices or expense reports and automatically submit them.

**Ron Schmelzer:** Or it could be doing things like helping radiologists do their job better, by looking at images, although that has not been proven to necessarily be as successful as we want it to be. Or it could be doing things that's not driving your car, but making you safer while you drive your car, keeping you in your lane, making sure that you're breaking in time, things like that.

**Ron Schmelzer:** So, these are where it's less sexy because we would love to have some autonomous robot doing all these things, that's what's in the movies. You don't see in the year 2300 an automated email invoicing system that just doesn't capture anybody's science fiction interest. It's boring, right? But that's where the practicality is.
...
We always like to say that AI is a tool in your toolbox, right? So it's not going to be the one solution that solves everything for you. Use it as any other tool, understands its limitations, understand what it's good at, and then make decisions from there because everything has a cost.

As Ron mentioned, you can type something in ChatGPT, say, type me this 3000 word article on project management, and it will give you something that's pretty good, but it's not going to be a hundred percent. You still should have a human in there editing it. You still should have a human in there doing something.

**Kathleen Walch:** So use AI as a tool, and yes, this is what happens, and Ron had mentioned to it earlier where artificial intelligence, I mean, the term was coined in 1956, this is not new. This has been around for decades. And you may say, yeah, but now it's different, why am I hearing about it now? And it's the third wave of AI.

**Kathleen Walch:** So AI has gone through two previous winters, which is a period of decline in investment, in popularity, in funding. And a main reason that it has gone into this hibernation winter period is that we overpromise and then under-deliver on what we can do. So we get really excited, we talk about all the possibilities, we say, oh my gosh, look what it can do. It can, it can write novels, it can write songs, it can write code, it can do all this stuff. And then when you actually put it into practice, you see some of the limitations with it and organizations go, maybe they put something out and then they get in trouble for plagiarism or they get in trouble, which it's not supposed to be, but you know, it's not perfect.
...
**Ron Schmelzer:** Absolutely. As a matter of fact, that's actually one of the places that a lot of organizations get tripped up. AI projects are actually not like typical application development projects. If you think about building, say, a website or a mobile app or any sort of something that requires, say, focused on the building part, because it turns out that part is fairly trivial.
...
**Ron Schmelzer:** And this is when you know how it works, well it's like a magic trick. It sort of takes the magic away and you're like, oh, it's just a big predictive, you know, when you type on your phone and you type the word first, and then it comes up with what it thinks the next word will be after that. Well, it's a very, very, very simple version of the same thing.

**Ron Schmelzer:** When you give ChatGPT a prompt, it'll come up with the next thousand words of what it thinks it's next. Now, the thing is, it's not just creating these words out of scratch. What it's doing is it's almost like we call it like a very intelligent parrot. It's just going back and be like, oh, I remember Pollyana.

**Ron Schmelzer:** Next thing is cracker. So Polly goes cracker, but it goes continues, right? Or you could think of it as like it's going to assemble a collage of all of this data, this training data that's had before, and it's going to assemble this collage by sniping things out of this magazine and that magazine, and next thing you know, you got 3000 words.
...
I think about the term that you'll hear software developers use all the time, which is technical debt. Sometimes you build this software product, and it's been around for so long because it's become ubiquitous. It has a lot of old code in it that it prevents you from innovating.

**Bill Raymond:** And so you almost have to start taking apart that old code and fixing it and reworking it so that you can do other things with it. And then famously Microsoft Office was on the desktop when all of a sudden everyone said, well, we want to do our word processing online. You can't just rip up all of Microsoft Word and say, now it's on the browser.
...
**Ron Schmelzer:** Because what you don't want to do in a project is basically say, oh, we have this great idea to do this thing, all we need is access to this data, and we'll do this, and this, you know, this stuff. And then that other person said, hold up, I'm not giving you access to that data. Well, that just killed your whole project, didn't it?
...
**Kathleen Walch:** That's why it's so important to follow a best practices methodology. That's why it's so important to understand even what it is you're trying to do. Because if you're like, I just want to do an AI project. Okay. What's your main goal? What's the ROIs that you're looking to get from this? What data do you have?

**Kathleen Walch:** You need to be making sure that you're asking all these questions, otherwise it's going to get very big, very complex, very overwhelming, very quickly. And then we've seen far too many AI projects fail.
...
This leads us into the conversation around CPMAI or Cognitive Project Management for AI.
...
**Ron Schmelzer:** And amazingly, they're just a fancy form of Big Data project, a very specific form. In the mid 2010s, we and others basicallyevolved the CRISPDM approach to become CPMAI, which is the Cognitive Project Manager for AI, which builds upon the same idea of these six iterative phases, that's what they're called in CRISPDM. We understand the word phase may be an issue for some, but it's these six steps that must be followed in a project, but they're iterative in that they can be, you can go back and forth when you realize you don't have enough data for something, or the method that you selected for doing analytics might not be appropriate.

**Ron Schmelzer:** You're allowed to go back. You don't have to push out your project with the bad data or bad algorithm. We can go into that now, but basically what CPMAI is, is this prescriptive approach that's iterative for running AI projects that's data centric and agile.
...
**Kathleen Walch:** So it starts off with business understanding. Figure out the problem you're actually trying to solve. Then data understanding. So we're going to think about our data environment, our data sources, data quality issues. Then we have data preparation. So this is about actually preparing our data, labeling it if we need.
...
**Ron Schmelzer:** Yeah, and it's not just learning the technology and learning the ropes of that. It really is also learning the right way to do things. I don't know why that's such a struggle. People will invest hundreds of thousands of dollars in tools and tens and hundreds of thousands of dollars in data and data preparation, but they won't spend like a penny on method, learning the right way. They're like, I'll just figure it out as I go along.
...
We can go into any C level right now, any Fortune 1000 organization and be like, there's a small percentage of you that are doing it right and a very large percentage of you that are not.

**Ron Schmelzer:** And yeah, we tell people, invest, invest in education, invest in training, and get a few people certified. Do it the right way. You know, there's no argument for not doing it the right way.

**Bill Raymond:** We were just talking at the beginning of this podcast that we use AI to edit our podcasts. I don't tell people I use AI to edit my podcast unless I'm talking to AI people like yourselves. What I say is, I have this great tool that recognizes the voices and automatically labels them and allows me to edit the podcast. This is of a document instead of trying to understand audio and video systems. And all these capabilities are AI based, but really what we're seeing is that they're useful to our organization. And if anyone thinks that something like ChatGPT is going to take over the world, I'm going to share a AI generated joke with you. You ready?

**Ron Schmelzer:** Sure I'm ready for it. Listeners, are you ready for it?

**Bill Raymond:** Why did the AI project fail? Because it had too many bugs and not enough debugging. Right? Uhhuh? So don't worry comedians, ChatGPT is not going to take over your job.

Was that, you basically asked ChatGPT to write the joke?
...
**Ron Schmelzer:** So what you just said was, I think nobody laughed, I think you should all feel comfort because that means AI ain't be takin' over anytime soon, so there you go.
...
**Bill Raymond:** However, I am going to show you a video and it's going to play some audio. We'll see how it comes out. If it doesn't come out good, then I'll put the audio right into the podcast for you. I'm going to play this and I'm going to ask you if you could figure out what elements are AI generated and which elements are not.

**Bill Raymond:** You ready?

**Kathleen Walch:** Okay.

**Bill Raymond:** All right.
...
**Ron Schmelzer:** Yeah, that whole thing was generated. Yeah. I'm thinking Lumen five. I got a little bit of the, yeah, maybe, I don't know how much the script you might have written on your own. Maybe. Maybe...

**Kathleen Walch:** I think you probably prompted it with obviously the titles that we are podcasts.

Maybe there's some element of you gen, but the rest of it was all generated. Because it's like yeah, for those of you that can't watch the video, there's lot of random stock art and there was a lot of in the future where...
...
**Ron Schmelzer:** Yes, that's it.

**Ron Schmelzer:** He was talking about how they're already doing all that. But you know what, it will be available, I'm not trying to plug any products here, but we're big users of a product called Canva, which is a really nice image and other generation tool. We would not be able to produce anything nearly as good.

**Ron Schmelzer:** And they're adding all sorts of AI elements into it now. It just makes stuff look so good, I mean, I think you'd be foolish now to use that. And I think that's where things are. We both have kids, Kathleen and I in elementary school and middle school. and the teachers now are like totally onto kids generating stuff.

**Ron Schmelzer:** So I think the biggest impact is going to be in schooling. I think the days of the essay are over.

**Kathleen Walch:** They're talking about writing them in person. Ron has a middle schooler and I think that's affecting him a lot more than my kindergartener, where we're still writing things by hand, but give it a few more years, right? They're going to become a lot more computer savvy. Maybe be writing some reports on the computer and will it all be their writing?

**Ron Schmelzer:** This is all the stuff we talk about on the AI Today Podcast, so...

**Bill Raymond:** Yeah, and we'll definitely provide a link to the AI Today Podcast on the Agile in Action website and of course on the podcast app that you might be listening to right now. And also is it possible for others to reach out to you, Kathleen and Ron directly?
