...
twitter-text: ""
libsynUrl: https://directory.libsyn.com/episode/index/id/26795235
guest-details:
  - guest-name: Keegan McBride
    ...
    guest-links:
      - guest-link-label: 🌎 Keegan's website
        guest-link-url: https://keeganmcbride.ee
        fieldGroup: guest-links
      - guest-link-label: 🌎 Keegan on LinkedIn
        guest-link-url: https://www.linkedin.com/in/keeganmcbride/
        fieldGroup: guest-links
      - guest-link-label: 🏫 Keegan at the Oxford Internet Institute, University of Oxford
        guest-link-url: https://www.oii.ox.ac.uk/people/profiles/keegan-mcbride
        fieldGroup: guest-links
  ...
  - guest-name: Maximilian Kupi
    ...
    guest-title: Computational Social Science Researcher at the Hertie School, Agile and Human-Centred Methods
    guest-links:
...
type: podcast
---
__Can the words 🏢 *Government* and 💨 *Agile* work together? When thoughtfully considered__
...
**Bill Raymond:** That's a great way to wrap up this podcast. I really appreciate both of your time. As a matter of fact, we actually found you through that research that you both did, which is _Agile Development for Digital Government Services, Challenges and Success Factors_ and we'll provide a link to that on the Agile in Action Podcast, and of course, in the show notes for this podcast. 
