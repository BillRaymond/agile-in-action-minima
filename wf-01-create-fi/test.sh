...
-layers flatten `# merge the template and guest photos`\
        ...
        +write ../uploads/wf-featured-images/2022-08-02-exciting-agile-in-action-podcast-news.png \
        -page +972+448 sc-play.png `# load play icon image`\
        -layers flatten \
        ../uploads/wf-featured-images/2022-08-02-exciting-agile-in-action-podcast-news-no-play.png
magick convert sc-template.png `# load template background image`\
...
-layers flatten `# merge the template and guest photos`\
        ...
        -geometry +550+446 `# Set the x and y position of the guest names`\
        -composite `# Add guest names to the image`\
        +write ../uploads/wf-featured-images/2022-06-14-what-it-means-to-become-nimble.png \
        -page +972+448 sc-play.png `# load play icon image`\
        -layers flatten \
        ../uploads/wf-featured-images/2022-06-14-what-it-means-to-become-nimble-no-play.png
magick convert sc-template.png `# load template background image`\
...
-layers flatten `# merge the template and guest photos`\
        ...
        -geometry +550+446 `# Set the x and y position of the guest names`\
        -composite `# Add guest names to the image`\
        +write ../uploads/wf-featured-images/2022-06-07-building-a-culture-of-psychological-safety.png \
        -page +972+448 sc-play.png `# load play icon image`\
        -layers flatten \
        ../uploads/wf-featured-images/2022-06-07-building-a-culture-of-psychological-safety-no-play.png
magick convert sc-template.png `# load template background image`\
...
-layers flatten `# merge the template and guest photos`\
        ...
        -geometry +550+446 `# Set the x and y position of the guest names`\
        -composite `# Add guest names to the image`\
        +write ../uploads/wf-featured-images/2022-05-16-successful-globally-distributed-teams.png \
        -page +972+448 sc-play.png `# load play icon image`\
        -layers flatten \
        ../uploads/wf-featured-images/2022-05-16-successful-globally-distributed-teams-no-play.png
magick convert sc-template.png `# load template background image`\
...
-layers flatten `# merge the template and guest photos`\
        ...
        -geometry +550+446 `# Set the x and y position of the guest names`\
        -composite `# Add guest names to the image`\
        +write ../uploads/wf-featured-images/2022-05-09-outcome-driven-design-and-team-behaviors.png \
        -page +972+448 sc-play.png `# load play icon image`\
        -layers flatten \
        ../uploads/wf-featured-images/2022-05-09-outcome-driven-design-and-team-behaviors-no-play.png
magick convert sc-template.png `# load template background image`\
...
-layers flatten `# merge the template and guest photos`\
        ...
        -geometry +550+446 `# Set the x and y position of the guest names`\
        -composite `# Add guest names to the image`\
        +write ../uploads/wf-featured-images/2022-04-12-the-art-and-science-of-facilitation.png \
        -page +972+448 sc-play.png `# load play icon image`\
        -layers flatten \
        ../uploads/wf-featured-images/2022-04-12-the-art-and-science-of-facilitation-no-play.png
magick convert sc-template.png `# load template background image`\
...
-layers flatten `# merge the template and guest photos`\
        ...
        -geometry +550+446 `# Set the x and y position of the guest names`\
        -composite `# Add guest names to the image`\
        +write ../uploads/wf-featured-images/2022-04-05-risk-driven-security-in-agile-software-development.png \
        -page +972+448 sc-play.png `# load play icon image`\
        -layers flatten \
        ../uploads/wf-featured-images/2022-04-05-risk-driven-security-in-agile-software-development-no-play.png
magick convert sc-template.png `# load template background image`\
...
-layers flatten `# merge the template and guest photos`\
        ...
        -geometry +550+446 `# Set the x and y position of the guest names`\
        -composite `# Add guest names to the image`\
        +write ../uploads/wf-featured-images/2022-03-29-introducing-objectives-and-key-results-okrs.png \
        -page +972+448 sc-play.png `# load play icon image`\
        -layers flatten \
        ../uploads/wf-featured-images/2022-03-29-introducing-objectives-and-key-results-okrs-no-play.png
magick convert sc-template.png `# load template background image`\
...
-layers flatten `# merge the template and guest photos`\
        ...
        -geometry +550+446 `# Set the x and y position of the guest names`\
        -composite `# Add guest names to the image`\
        +write ../uploads/wf-featured-images/2022-03-22-how-team-self-selection-helps-people-excel.png \
        -page +972+448 sc-play.png `# load play icon image`\
        -layers flatten \
        ../uploads/wf-featured-images/2022-03-22-how-team-self-selection-helps-people-excel-no-play.png
magick convert sc-template.png `# load template background image`\
...
-layers flatten `# merge the template and guest photos`\
        ...
        -geometry +550+446 `# Set the x and y position of the guest names`\
        -composite `# Add guest names to the image`\
        +write ../uploads/wf-featured-images/2022-03-15-the-planet-is-also-the-customer-agile-and-sustainabilty.png \
        -page +972+448 sc-play.png `# load play icon image`\
        -layers flatten \
        ../uploads/wf-featured-images/2022-03-15-the-planet-is-also-the-customer-agile-and-sustainabilty-no-play.png
